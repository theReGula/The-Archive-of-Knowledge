...
const MATAKULIAH = [
  ...
  /* ======================= PRAKTIKUM PETROGRAFI ======================= */
  {
    ...
    minggu: [
      ...
      { ke: 4, judul: 'Identifikasi mineral pembentuk batuan', catatan: 'Lembar kerja diisi langsung di lab lewat HP. Pilih ketembusan cahaya dulu di kepala kartu, karena kolom yang muncul menyesuaikan pilihan itu. Kirim sebelum sesi berakhir, catat nomor tanda terimanya.', berkas: [] },
      { ke: 5, judul: '', catatan: '', berkas: [{ nama: 'Lembar Kerja 4', tipe: 'lk', url: '/petrografi/lk3/', tersedia: true },
