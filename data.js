  ...
  /* ======================= PRAKTIKUM PETROGRAFI ======================= */
  {
    ...
    minggu: [
      ...
      { ke: 3, judul: 'Mikroskop polarisasi dan sifat optik mineral', catatan: 'Lembar kerja diisi langsung di lab lewat HP. Kirim sebelum sesi berakhir, catat nomor tanda terimanya.', berkas: [{ nama: 'Lembar Kerja 1', tipe: 'lk', url: '/petrografi/lk1/', tersedia: true },
          { nama: 'Slide Minggu 3', tipe: 'slide', url: 'https://drive.google.com/file/d/1-dDWJh9TDG3-SV6jUmzlQWFHNo6SBhYZ/view', tersedia: false },
          { nama: 'Cek Nilai disini', tipe: 'cek nilai', url: 'https://the-archive-of-knowledge.netlify.app/petrografi/pantau/', tersedia: false },
